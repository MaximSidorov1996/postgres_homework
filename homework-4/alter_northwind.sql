...
-- Один из возможных способов решить эту задачу - это использовать каскадное удаление. Для этого нужно изменить ограничение foreign_key в таблице order_details так, чтобы добавить опцию ON DELETE CASCADE.
...
-- Теперь можно безопасно удалить товары, снятые с продажи, из таблицы products.
